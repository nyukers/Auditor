...
For Each objLogfile in colLogFiles
    errBackupLog = objLogFile.BackupEventLog("d:\"& HostName &"_app.evt")
...
For Each objLogfile in colLogFiles
    errBackupLog = objLogFile.BackupEventLog("d:\"& HostName &"_sec.evt")
    If errBackupLog <> 0 Then        
...
For Each objLogfile in colLogFiles
    errBackupLog = objLogFile.BackupEventLog("d:\"& HostName &"_sys.evt")
    If errBackupLog <> 0 Then        
